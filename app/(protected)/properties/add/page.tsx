...
export default function AddPropertyPage() {
  ...
  // imageUrls stored as array; we collect one URL at a time for simplicity
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic custom validation checks before submit
    ...
    try {
      ...
      setError("Network error. Please check database connection and try again.");
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-col gap-2 mb-10 text-left">
        ...
        <p className="text-muted-foreground text-sm">
          Provide accurate details about your property to attract buyers and renters.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="col-span-1 sm:col-span-2 flex flex-col gap-1.5">
              ...
              <input
                ...
                placeholder="e.g. 5 Marla Modern House for Sale in Regi Model Town"
            ...
            <div className="col-span-1 sm:col-span-2 flex flex-col gap-1.5">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe features like structure, surrounding area details, nearby schools, utility supply..."
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="col-span-1 sm:col-span-3 flex flex-col gap-1.5">
              ...
              <input
                ...
                value={form.address}
                onChange={handleChange}
                placeholder="e.g. House 44, Street 3, Sector B-1"
                className="w-full h-11 px-4 rounded-xl border border-border bg-background text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col gap-1.5 col-span-2">
              ...
              <input
                ...
                value={form.marla}
                onChange={handleChange}
                placeholder="e.g. 5 or 20 (for 1 Kanal)"
                className="w-full h-11 px-4 rounded-xl border border-border bg-background text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all"
              />
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 flex flex-col gap-1 text-left">
                  ...
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    Upload multiple photos. Each click adds one image. Max size: 10MB per image.
                  </p>
                  {imageUrls.length > 0 && (
